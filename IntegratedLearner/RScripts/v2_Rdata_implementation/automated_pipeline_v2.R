...
run_one <- function(args, run_id, seed, return_big = FALSE) {
  ...
  final_results <- list(
    ...
    validation_models = list(
      metabolomics = metab_model_folds,
      mss = mss_model_folds,
      concat_none = concat_none_model_folds,
      concat_scaling = concat_scaling_model_folds,
      concat_scaling_weights = concat_sw_model_folds
    ),
    
    final_base_models = list(
      metabolomics = final_metab_fit,
      mss = final_mss_fit,
      concat_none = final_concat_none_fit,
      concat_scaling = final_concat_scaling_fit,
      concat_scaling_weights = final_concat_sw_fit
    ),
