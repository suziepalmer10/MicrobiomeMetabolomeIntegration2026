...
setwd("/home2/s180020/Desktop/IntegratedLearner_Revisions_02242026/A_Data_Processing/microbiome-metabolome-curated-data/data/processed_data/ERAWIJANTARI_GASTRIC_CANCER_2020")

#SECTION 1: COMBINE, SCALE AND FILTER DATA. 
metadata_cols <- c("Sample", "Study.Group", 'Total_Cholesterol', 'Glucose')
##load in datasets
...
write.csv(processed_data, file = "Erawijantari_data.csv", row.names = FALSE) 
